...
```
go get github.com/rsaranusc/openai-compatible
```
Currently, openai-compatible requires Go version 1.18 or greater.
...
import (
	"context"
	"fmt"
	openai "github.com/rsaranusc/openai-compatible"
)
...
See also: https://pkg.go.dev/github.com/rsaranusc/openai-compatible#ClientConfig
</details>
...
import (
	...
	"github.com/rsaranusc/openai-compatible"
	"github.com/rsaranusc/openai-compatible/jsonschema"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/rsaranusc/openai-compatible/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/rsaranusc/openai-compatible/issues/62)
